...
- diferenciar chat, MCP, Skills, plugins, apps y API;
- entender agentes, subagentes, tareas programadas y trabajo agéntico;
...
- [`curso-fundamentos-ia.md`](./curso-fundamentos-ia.md): contenido principal del curso.
- [`banco-de-escenarios.md`](./banco-de-escenarios.md): casos por audiencia para PyMEs, corporativos, servicios profesionales, educación y marketing.
...
- MCP, Skills, plugins, apps y API;
- agentes y sistemas;
- diferencias entre experiencias de plataforma y construcción técnica.

El alumno no debe repetir el proyecto del curso 01. Aquí debe aplicar esas habilidades para decidir **qué tecnología, plataforma o nivel de autonomía necesita realmente**.
